...
!!    optional = F
!!
subroutine chemistry_driver_ros_init(Time, dt, ncnst, errmsg, errflg)
...
!!    optional = F
!!
subroutine chemistry_driver_ros_run(vmr, Time, dt, j_rateConst,  k_rateConst, c_m, errmsg, errflg)
